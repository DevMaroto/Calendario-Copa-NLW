...
document.querySelector("#cards").innerHTML = 
    ...
    createCard("02/12", "sexta", createGame("south-korea", "12:00", "portugal") + createGame("ghana", "12:00", "uruguay") + createGame("cameroon", "16:00", "brazil") + createGame("serbia", "16:00", "switzerland"))
